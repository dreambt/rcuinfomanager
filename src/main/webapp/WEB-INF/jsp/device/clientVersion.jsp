...
<tbody>
    ...
    <tr>
        ...
        <td align="left">
            <input type="text" name=""  value="" style="width: 140px;height: 25px; margin-top: 5px;"/>
        </td>
    ...
    <tr>
        ...
        <td align="left">
            <input type="file" name=""  value="" style="color:#999999"
                   readonly="readonly"/>
        </td>
        <td align="center" bgcolor="#b4d8ed" style="color:#161823">
            <input type="checkbox" name="" value=""/>是否强制更新
        </td>
        <td align="center">
