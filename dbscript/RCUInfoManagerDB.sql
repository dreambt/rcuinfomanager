...
CREATE TABLE `familyassets` (
  ...
  `recordId` bigint(20) DEFAULT NULL,
  `fmAllAssets` decimal(10,4) DEFAULT 0.00,
...
CREATE TABLE `incomeexpenses` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `recordId` bigint(20) DEFAULT NULL,
  `fmAllIncome` double(8,4) DEFAULT 0.00,
  `fmExpenses` double(8,4) DEFAULT 0.00,
  `incomeSrc` varchar(50) DEFAULT NULL,
  `perIncome` double(8,4) DEFAULT 0.00,
  `fmOtherMemberIn` double(8,4) DEFAULT 0.00,
