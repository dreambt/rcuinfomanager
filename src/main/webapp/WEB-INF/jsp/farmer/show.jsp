...
<p class="text-center">
    <button class="btn" type="button" id="appointOperate">指派</button>
    <button class="btn" type="button" id="deleteOperate">删除</button>
    <button class="btn" type="button" id="checkOperate">验收</button>
    <button class="btn" type="button" id="editOperate">编辑</button>
</p>
