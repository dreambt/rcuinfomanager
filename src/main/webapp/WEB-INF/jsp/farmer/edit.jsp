...
<table class="table table-bordered" width="100%" height=100%; border="3">
<tbody>
...
<tr>
    ...
    <td align="center" colspan="2">
        <select class="selectpicker" style="width: 155px; margin-top: 10px;">
    ...
    <td align="center" colspan="2">
        <input class="input-small" type="text" name="customerName" value="${personBasic.cerNum}"
               style="width: 175px;height: 30px; margin-top: 10px;">
    </td>
...
<tr>
    ...
    <td align="center" colspan="3">
        <input class="input-small" type="text" name="customerName" value="${personBasic.cerValidityFrom}"
               style="width: 155px;height: 30px; margin-top: 10px;"> -
...
<tr>
    ...
    <td align="center" colspan="5">
        <input class="input-xxlarge" type="text" name="customerName" value="${personBasic.address}"
...
<tr>
    ...
    <td align="center" colspan="4"><%--${personBasic.socialSecurity}--%>
...
<tr>
    ...
    <td align="center" colspan="7">
        <select class="selectpicker" style="width: 390px; margin-top: 10px;">
...
<tr>
    ...
    <td align="center" colspan="4">
        <input class="input-small" type="text" name="customerName" value="${personBasic.businessProj}"
               style="width: 390px;height: 30px; margin-top: 10px;">
    </td>
    ...
    <td align="center" colspan="2">
        <input class="input-small" type="text" name="customerName" value="${personBasic.businessYear}"
               style="width: 165px;height: 30px; margin-top: 10px;">
    </td>
</tr>
<tr>
    <td align="center" bgcolor="#b4d8ed" style="color:#161823">
    ...
    <td align="center" colspan="3">
        <input class="input-small" type="text" name="customerName" value="${personBasic.businessSite}"
               style="width: 278px;height: 30px; margin-top: 10px;">
    </td>
    <td align="center" bgcolor="#b4d8ed" style="color:#161823">从事行业</td>
    <td align="center" colspan="3">
        <select class="selectpicker" style="width: 285px; margin-top: 10px;">
...
<tr>
    ...
    <td align="center" colspan="7">
        <select class="selectpicker" style="width: 530px; margin-top: 10px;">
...
<tr>
    ...
    <td align="center" colspan="7">
        <input class="input-xxlarge" type="text" name="customerName" value="${personBasic.workSitu}"
               style="height: 30px; margin-top: 10px;">
    </td>
</tr>
<tr>
    ...
    <td align="center" colspan="3">
        <select class="selectpicker" style="width: 280px; margin-top: 10px;">
...
<tr>
    ...
    <td align="center" colspan="3">
        <input class="input-small" type="text" name="customerName" value="${personBasic.department}"
               style="width: 280px;height: 30px; margin-top: 10px;">
    </td>
    ...
    <tr>
        ...
        <td align="center" colspan="7">
            <input class="input-small" type="text" name="customerName" value="${personIncomeExpenses.incomeSrc}"
                   style="width: 415px;height: 30px; margin-top: 10px;">
        </td>
    </tr>
    <tr>
        <td align="center" colspan="2" bgcolor="#b4d8ed" style="color:#161823">
...
<tr>
    <td align="center" colspan="8" style="font-size:22px">
        ...
        <p class="text-center">
            家庭资产情况
            <button class="btn btn-warning" type="button">增加房产</button>
...
<core:forEach items="${personFamilyAssetsList}" var="personFamilyAssets">
    <tr>
        ...
        <td align="center" colspan="5"><%--${personFamilyAssets.mainAssets}--%>
            <label class="checkbox inline">
            ...
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox9" value="option4"> 金融资产
            </label>
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox10" value="option5"> 经营资金
            </label>
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox11" value="option5"> 其他
            </label>
        </td>
    </tr>
</core:forEach>
    ...
    <tr>
        ...
        <td align="center" colspan="3">
            <input class="input-small" type="text" name="customerName" value="${personHousePropertyInfo.note1}"
                   style="width: 295px;height: 30px; margin-top: 10px;">
        </td>
    </tr>
</core:forEach>
...
<core:forEach items="${personLandInfoList}" var="personLandInfo">
    ...
    <tr>
        ...
        <td align="center" colspan="5">
            <select class="selectpicker" style="width: 395px; margin-top: 10px;">
...
<core:forEach items="${personFinancialAssetsList}" var="personFinancialAssets">
    <tr>
        <td align="center" bgcolor="#b4d8ed" style="color:#161823">情况</td>
        <td align="center" colspan="3"><%--${personFinancialAssets.financialInfo}--%>
            <label class="checkbox inline">
            ...
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox15" value="option4"> 基金
            </label>
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox16" value="option5"> 债劵
            </label>
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox17" value="option5"> 投资性保险
            </label>
            <label class="checkbox inline">
                <input type="checkbox" id="inlineCheckbox18" value="option5"> 其他
            </label>
        </td>
