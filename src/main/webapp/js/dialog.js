...
(function (window, undefined) {
    ...
    $.fn = $.prototype = {constructor: $, ready: function (callback) {
        $.bindReady();
        if ($.isReady) {
    ...
    $.event = {add: function (elem, type, callback) {
        ...
        var event2 = {target: event.srcElement || document, preventDefault: function () {
    ...
    $.fn.animate = function (prop, speed, easing, callback) {
        ...
        var $this = this, overflow, fx, parts, start, end, unit, opt = {speed: speed, easing: easing, callback: function () {
...
(function ($, window, undefined) {
    ...
    var artDialog = function (config, ok, cancel) {
        ...
        ;
        $.each({ok: "yesFn", cancel: "noFn", close: "closeFn", init: "initFn", okVal: "yesText", cancelVal: "noText"}, function (i, o) {
    ...
    artDialog.fn = artDialog.prototype = {version: '4.1.2', _init: function (config) {
    ...
    artDialog.defaults = {content: '<div class="aui_loading"><span>loading..</span></div>', title: '\u6d88\u606f', button: null, ok: null, cancel: null, init: null, close: null, okVal: '\u786E\u5B9A', cancelVal: '\u53D6\u6D88', width: 'auto', height: 'auto', minWidth: 96, minHeight: 32, padding: '20px 25px', skin: '', icon: null, time: null, esc: true, focus: true, show: true, follow: null, path: _path, lock: true, background: '#000', opacity: .7, duration: 300, fixed: false, left: '50%', top: '38.2%', zIndex: 1987, resize: true, drag: true};
...
(function ($) {
    ...
    artDialog.dragEvent.prototype = {onstart: $.noop, start: function (event) {
