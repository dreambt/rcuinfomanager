...
(function (h, e, l) {
    ...
    g.fn = g.prototype = {version: "4.1.6", closed: !0, _init: function (a) {
        ...
        r && h(function () {
            "fixed" !== m.css("backgroundAttachment") && "fixed" !== h("body").css("backgroundAttachment") && m.css({zoom: 1, backgroundImage: "url(about:blank)", backgroundAttachment: "fixed"})
        });
        return function () {
...
(function (h) {
    ...
    artDialog.dragEvent.prototype = {onstart: h.noop, start: function (e) {
