				...
				<tbody>
					...
					<tr>
						...
						<td align="left" colspan="3">
							...
							到 &nbsp;&nbsp;<input type="text" name="end_time" id="end_time" value="" size="10" class="date input-text" readonly="">&nbsp;
							<script type="text/javascript">
								Calendar.setup({
								weekNumbers: false,
								inputField : "end_time",
					...
					<tr>
						...
						<td align="center" bgcolor="#1e90ff" style="color:#FFFFFF">证件号码</td>
						<td align="left" colspan="3"><INPUT id="u2522" type=text value="350583198011151353" maxlength="18"  style="width:200px"></td>
					</tr>
					<tr>
						<td align="left" colspan="8" style="font-size:18px">
							成员：2						
