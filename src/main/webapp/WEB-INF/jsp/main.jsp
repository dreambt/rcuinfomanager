                ...
                <table width="100%">
                    ...
                    <tr>
                        <td align="center" class="first">
                            <input class="checkOpera" type="checkbox" recordId=""/>
                        </td>
                        <td align="center">3</td>
                        <td align="center">老李</td>
                        <td align="center"><p>123125652</p></td>
                        <td align="center">2013年1月</td>
                        <td align="center">&nbsp;</td>
                        <td align="center">&nbsp;</td>
                        <td align="center">未指派</td>
                        <td align="center">
                            <a href="#" style="color:#0099FF" id="showOperate">查看</a>&nbsp;|&nbsp;
                            <a href="#" style="color:#0099FF" id="appointOperate">指派</a>&nbsp;|&nbsp;
                            <a href="#" style="color:#0099FF" id="editOperate">编辑</a>&nbsp;|&nbsp;
                            <a href="#" style="color:#FF0000" id="delteOperate">删除</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
