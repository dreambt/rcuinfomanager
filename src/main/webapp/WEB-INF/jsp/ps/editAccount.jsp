    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#cancelOperate').click(function() {
                window.top.art.dialog({id : 'editAccount' }).close();
            });
            //返回main
...
<form method="post">
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <td align="left">
                <input  type="text" name="" value="" style="width: 200px;height: 30px; margin-top: 10px;"/>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td align="left">
                <input type="text" name="customerName" value="" style="width: 200px;height: 30px; margin-top: 10px;">
            </td>
        </tr>
        <tr>
            <td align="right">
